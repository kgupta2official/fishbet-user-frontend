...
const VipPage = () => {
  ...
  return (
    <div className="p-6 bg-[hsl(var(--main-background))] relative">
        ...
        <>
          ...
          >
            ...
            <div className="mb-5 mb-3 w-full max-w-[350px] lg:mb-0 ">
              ...
              <Card className="h-auto bg-[rgb(var(--lb-purple-1600))] border-2 border-[var(--lb-purple-1400)] p-2 rounded-lg shadow-lg w-full min-w-[250px] max-w-[350px]">
            ...
            <div className="h-full w-full lg:w-auto my-auto">
              ...
              <div
                className={`flex overflow  gap-4 ${styles.scrollbarcontainer}  ${rightPanel ? '  lg:w-[68vw]' : 'lg:w-[41vw]'}`}
              >
                {fieldProgress?.map((fields, index) => (
                  <Card
                    key={index}
                    className="h-auto w-[700px] bg-[rgb(var(--lb-purple-1500))] border-2 border-[var(--lb-purple-1400)] rounded-lg shadow-lg pt-0"
                  >
                    <Progress
