      ...
      <div className="flex gap-2">
        <Popover className="border-none mt-auto">
          <PopoverTrigger asChild>
            <Button
              ...
              className="w-[85%] py-2 bg-green-400  text-blue-950 hover:bg-purple-600 hover:text-white transition-colors"
            >
          ...
          <PopoverContent className="max-w-[280px] bg-gradient-to-b from-gray-800 to-gray-900 p-5 rounded-xl shadow-2xl border border-[var(--progress-bar)]">
            ...
            <ul className="text-gray-300 text-sm space-y-4">
              {rewards.map((reward) => (
                <li
                  key={reward?.rewardId}
                  className="bg-[var(--progress-bar)] rounded-lg p-3 border border-gray-600 shadow-md hover:shadow-lg transition-shadow"
                >
        ...
        <Popover className="border-none mt-auto">
          ...
          <PopoverContent className="max-w-[280px] bg-gradient-to-b from-gray-800 to-gray-900 p-5 rounded-xl shadow-2xl border border-[var(--progress-bar)]">
            ...
            <ul className="text-gray-300 text-sm space-y-4">
              <li className="bg-[var(--progress-bar)] rounded-lg p-3 border border-gray-600 shadow-md hover:shadow-lg transition-shadow">
