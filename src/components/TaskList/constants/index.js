...
export const activeTaskList = [
  ...
  },
  {
    ...
    missionTarget: [
      {
        text: 'Follow fishbetStarsofficial twitter, get the latest news and grab the bonus drop in time',
      },
      {
        list: [],
      },
...
export const claimedTaskList = [
  {
    ...
    missionTarget: [
      {
        text: 'Join the fishbetStarstelegram channel, and get the bonus drop just in time!',
      },
      {
        list: [],
      },
