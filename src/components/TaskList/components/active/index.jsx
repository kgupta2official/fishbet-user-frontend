      ...
      {activeTaskList?.map(({ id, label, task, remainingDays }) => (
        <Accordion key={id} type="single" collapsible className="mt-4">
          <AccordionItem value="item-1" className="border-b-0">
            <AccordionTrigger className="bg-[hsl(var(--side-bar-card))] text-white font-bold rounded px-3 py-2 hover:bg-[#848D96] hover:no-underline">
              <div>
                <span>{label}</span>
            ...
            <AccordionContent className="bg-[rgb(var(--lb-blue-900))] p-1">
