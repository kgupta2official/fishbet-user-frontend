...
function ProfileSection() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="flex items-center hover:bg-[rgb(var(--header))] sm:mr-10">
      ...
      <DropdownMenuContent className="bg-[rgb(var(--header))] border-none mt-5 mr-2 shadow-lg">
