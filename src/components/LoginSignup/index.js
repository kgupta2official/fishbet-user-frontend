          ...
          <DialogHeader className="w-full">
            <div className="flex w-full h-full">
              <Tabs defaultValue="signIn" className="w-full p-2 flex flex-col">
                ...
                <div className="styles_bannerTile__9ggXg styles_promoteBanner__xl8Ho"><img src="https://storage.googleapis.com/www.mcluck.com/mcluck-images/login/promo_banner_v2.png" alt="login promo banner" data-test="login-promo-banner" className="styles_bannerTile-image__Pothl" /></div>
