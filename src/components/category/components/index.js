  ...
  return (
    <div className="mb-6 bg-[hsl(var(--main-background))]">
      <div className="font-bold text-2xl h-20 flex  justify-between items-center bg-[hsl(var(--lb-purple-950))] mb-6">
        <h1 className="font-bold text-2xl mx-8 text-black">{providerData?.name?.EN
          ? providerData.name.EN.charAt(0).toUpperCase() + providerData.name.EN.slice(1).toLowerCase()
          : ''}</h1>
        <Image
      ...
      <div className=" mb-3">
        {isEmpty(formateData[0]) && !loading ? (
          ...
          <div className="overflow-hidden mx-auto w-[100%] sm:w-[98%]">
            <div
              className={`grid grid-cols-3 sm:grid-cols-4  2xl:grid-cols-7 ${state.rightPanel
