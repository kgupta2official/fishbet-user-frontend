            ...
            {bannerList.map((banner, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col items-start pt-16 mx-1 sm:pb-8">
                  <h1 className="text-zinc-100 text-4xl font-medium pt-12 sm:pt-8 mx-6 sm:pl-6 sm:text-[50px] sm:font-bold sm:mx-8 max-w-40 sm:max-w-96 leading-6 sm:leading-10">
                     {banner?.title?.EN || ''}
                  </h1>
                  <p className="text-zinc-200  text-xs mx-6 font-normal sm:font-normal sm:pl-6 sm:mx-8 sm:text-base  mt-1 max-w-40 sm:max-w-96 leading-3 sm:leading-5">
