        ...
        <div className="w-full flex flex-col justify-center items-center space-y-4 text-white">
          <div className="flex  justify-between w-full">
            ...
            <div className="ml-4 flex flex-col justify-between w-full">
              <div className="flex justify-between mb-1">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      onClick={onclick}
                      className="bg-[rgb(var(--lb-purple-1100))] hover:bg-[rgb(var(--lb-purple-1000))] rounded-md font-bold sm:text-base p-1 px-2 sm:py-5 shadow-sm"
                    >
                      Play Now
                    </Button>
                  </TooltipTrigger>
              ...
              <div className="p-1 sm:p-4 bg-[rgb(var(--lb-blue-900))] rounded-md text-sm mr-1 sm:mr-0 ">
          ...
          <div className="bg-[rgb(var(--lb-blue-900))] w-full rounded-md p-4">
            <div className="text-3xl text-center text-green-400 font-bold">
              {total || 0} SC
            </div>
            <div className="bg-[rgb(var(--lb-blue-700))] flex justify-between items-center p-3 mt-3 rounded-md">
